        ...
        <Box sx={{bgcolor:'#FFFFFF', padding: '4rem'}}>
          ...
          <Grid container spacing={2} >
            ...
            <Grid item xs={12} sm={6} md={6} key={1}>
              <Card className='benefitCard' sx={{ minHeight:'260px', p: '2rem', flexGrow:'1', bgcolor:'#fdfdfd', color:'#f1f1f1', boxShadow:'4px 8px 8px -4px rgb(202, 213, 216)', borderRadius:'1rem'}}>
